...
git clone https://gitlab.crio.do/COHORT_ME_BUILDOUT_XMEME_ENROLL_1612436694845/amandey987-me_buildout_xmeme.git

cd amandey987-ME_BUILDOUT_XMEME
...
curl --location --request GET 'http://localhost:8081/meme'


# Execute the POST /memes endpoint using curl

curl --location --request POST 'http://localhost:8081/meme' \
